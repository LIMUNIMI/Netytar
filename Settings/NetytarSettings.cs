...
namespace Netytar.Settings
{
    ...
    public class NetytarSettings
    {
        ...
        public NetytarSettings(_BlinkSelectScaleMode blinkSelectScaleMode, _BreathControlModes breathControlMode, int ellipseRadius, int highlightRadius, int highlightStrokeDim, int horizontalSpacer, int lineThickness, int midiPort, _ModulationControlModes modulationControlMode, NetytarInteractionMethods interactionMethod, bool noteNamesVisualized, int occluderOffset, AbsNotes rootNote, ScaleCodes scaleCode, int sensorPort, _SharpNotesModes sharpNotesMode, _SlidePlayModes slidePlayMode, int verticalSpacer)
        {
